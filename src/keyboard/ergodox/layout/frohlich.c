/* ----------------------------------------------------------------------------
 * ergoDOX layout : Frohlich (modified from the Dvorak layout)
 * ----------------------------------------------------------------------------
...
// left hand
     _equal,         _1,         _2,      _3,      _4, _5,      _esc,
       _esc,     _quote,     _comma, _period,      _P, _Y, _bracketL,
       _tab,         _A,         _O,      _E,      _U, _I,
      _guiL, _semicolon,         _Q,      _J,      _K, _X,         1,
...
// left hand
  ...
  0,  _bracketL,  _bracketR, _bracketL, _bracketR,         0, _esc,
